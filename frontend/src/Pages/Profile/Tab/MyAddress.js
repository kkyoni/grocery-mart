            ...
            if (this.state.notrecordloading) {
                All_User_Address_HTMLTABLE =
                    this.state.alluserAddress.map((item, i) => {
                        return (
                            <div key={i} className={item.id === Number(login.address_id) ? ("relative border-2 rounded p-4 w-[200px] border-primary-color") : ("relative border-2 rounded p-4 w-[200px]")}>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="row modal-body">
                                <section className="w3l-contact" id="contact">
                                    <form method="post" className="signin-form" onSubmit={this.EditAddress}>
                                            ...
                                            <div className="row contact-block">
                                                <div className="col-md-6 contact-left">
                                                    <div className="input-grids">
                                                        ...
                                                        <input type="email" className="contact-input" id="w3lSender" name="country" placeholder="Country" onChange={this.handleInput} value={this.state.country} required="" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6 contact-right">
                                                    <div className="input-grids">
                                                        ...
                                                        <input type="email" className="contact-input" id="w3lSender" name="states" placeholder="States" onChange={this.handleInput} value={this.state.states} required="" />
