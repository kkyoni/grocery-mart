                    ...
                    <div class="ibox-content">
                        <div class="col-md-12 text-right">
                            <a class="btn btn-primary btn-sm pull-right mb-3 op-btn them"
                                href="<?php echo e(route('admin.promo.create')); ?>">
                                <i class="icon-plus fa-fw"></i>Add Promo</a>
    ...
    <script type="text/javascript">
        $(document).on("click", "a.deletepromo", function(e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(route('admin.promo.delete', [''])); ?>" + "/" + id,
                        type: 'post',
                        data: {
        ...
        $(document).on("click", "a.Showpromo", function(e) {
            ...
            var id = $(this).attr('data-id');
            $.ajax({
                url: "<?php echo e(route('admin.promo.show')); ?>",
                type: 'get',
                data: {
                    id: id
                },
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\backend\backend\resources\views/admin/pages/promo/index.blade.php ENDPATH**/ ?>