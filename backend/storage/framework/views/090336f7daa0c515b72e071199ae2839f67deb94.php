                    ...
                    <div class="ibox-content">
                        <div class="col-md-12 text-right">
                            <a class="btn btn-primary btn-sm pull-right mb-3 op-btn them"
                                href="<?php echo e(route('admin.user.create')); ?>"><i class="fa fa-plus"></i> Add Users</a>
    ...
    <script>
        $(document).on("click", "a.deleteuser", function(e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(route('admin.user.delete', [''])); ?>" + "/" + id,
                        type: 'post',
                        data: {
        ...
        $(document).on("click", "a.ShowUser", function(e) {
            ...
            var id = $(this).attr('data-id');
            $.ajax({
                url: "<?php echo e(route('admin.user.show')); ?>",
                type: 'get',
                data: {
                    id: id
                },
        ...
        $(document).on("click", ".changeStatusRecord", function(e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(route('admin.user.change_status', 'replaceid')); ?>",
                        type: 'post',
                        data: {
                            "_method": 'post',
                            'id': id,
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/grocery-mart/backend/resources/views/admin/pages/user/index.blade.php ENDPATH**/ ?>