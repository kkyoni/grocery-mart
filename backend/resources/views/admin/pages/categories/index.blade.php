...
@section('mainContent')
    <div class="row wrapper border-bottom white-bg page-heading mb-5">
        <div class="col-lg-12">
            <h2><i class="fa fa-list-alt" aria-hidden="true"></i> Categories Management</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.dashboard') }}">Dashboard</a>
                </li>
                <li class="breadcrumb-item active">
                    <span class="label label-success float-right all_backgroud"><strong>Categories Table</strong></span>
                </li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="ibox-content">
                        <div class="col-md-12 text-right">
                            <a class="btn btn-primary btn-sm pull-right mb-3 op-btn them"
                                href="{{ route('admin.categories.create') }}"><i class="fa fa-plus"></i> Add Categories</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title pull-left" id="exampleModalLabel1">Categories Detail</h5>
...
<script src="//cdn.datatables.net/buttons/1.3.1/js/buttons.print.min.js"></script>
    ...
    <script type="text/javascript">
        $(document).on("click", "a.deletecategories", function(e) {
            var row = $(this);
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "{{ route('admin.categories.delete', ['']) }}" + "/" + id,
                        type: 'post',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
                    ...
                    swal("Cancelled", "Your categories is safe :)", "error");
                }
            });
            return false;
        })
