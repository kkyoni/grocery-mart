...
<div class="row wrapper border-bottom white-bg page-heading mb-5">
	<div class="col-lg-12">
		<h2><i class="fa fa-list-alt" aria-hidden="true"></i> Add Categories From Management</h2>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">
				<span class="label label-success float-right all_backgroud"><strong>Add Categories Form</strong></span>
			</li>
		</ol>
	</div>
</div>
		...
		<div class="col-lg-12">
			<div class="ibox">
				<div class="ibox-content">
					{!! Form::open(['route'	=> ['admin.categories.store'],'id' => 'CreateForm','files' => 'true'])!!}
