                ...
                <div class="tm_invoice_in">
                    ...
                    <div class="tm_invoice_info tm_mb20">
                        ...
                        <div class="tm_invoice_info_list">
                            <p class="tm_invoice_number tm_m0">Invoice No: <b class="tm_primary_color">#{{ $order->invoice }}</b></p>
                            <p class="tm_invoice_date tm_m0">Date: <b class="tm_primary_color">{{ date_format($order->created_at, 'd.m.Y') }}</b></p>
                        </div>
                    </div>
                    <div class="tm_invoice_head tm_mb10">
                        <div class="tm_invoice_left">
                            ...
                            <p>
                                Grocery Mart <br>
                                5th Avenue, 12202 street, <br>USA. <br>
                                example@mail.com
                            </p>
                        </div>
                        <div class="tm_invoice_right tm_text_right">
                        ...
                        <div class="tm_round_border">
                            <div class="tm_table_responsive">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="tm_width_1 tm_semi_bold tm_primary_color tm_gray_bg">No</th>
                                            ...
                                            <th class="tm_width_3 tm_semi_bold tm_primary_color tm_gray_bg">Price</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($ProductOrder as $value)
                                            <tr>
                                                ...
                                                <td class="tm_width_3"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{ $value->price }}
                                                </td>
                                                <td class="tm_width_2 tm_text_right"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                                    {{ $value->price }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{ $order->maintotal }} </td>
                                        </tr>
                                        <tr>
                                            <td
                                            ...
                                            <td
                                                ...
                                                +<span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> 0.00</td>
                                        </tr>
                                        <tr>
                                            <td
                                                class="tm_width_3 tm_primary_color tm_border_none tm_pt0">
                                                Sales Tax
                                                <span class="tm_ternary_color">(0%)</span>
                                            </td>
                                            <td
                                                class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">
                                                +<span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> 0.00</td>
                                        ...
                                        <tr>
                                            <td
                                                class="tm_width_3 tm_primary_color tm_border_none tm_pt0 tm_bold">
                                                Promo
                                                Code</td>
                                            <td
                                                class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0 tm_bold">
                                                -<span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{ $order->promototal }} </td>
                                        </tr>
                                        <tr class="tm_border_top tm_border_bottom">
                                            ...
                                            <td
                                                ...
                                                <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{ $order->grandtotal }} </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="tm_padd_15_20 tm_round_border">
                        <p class="tm_mb5"><b class="tm_primary_color">Terms & Conditions:</b>
                        </p>
                        <ul class="tm_m0 tm_note_list">
                            <li>All claims relating to quantity or shipping errors shall be
                                waived by Buyer unless made
                                in writing to Seller within thirty (30) days after delivery of
                                goods to the address
                                stated.</li>
                            <li>Delivery dates are not guaranteed and Seller has no liability
                                for damages that may be
                                incurred due to any delay in shipment of goods hereunder. Taxes
                                are excluded unless
                                otherwise stated.</li>
                        </ul>
                    </div>
