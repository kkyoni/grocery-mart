...
@section('mainContent')
    <div class="row wrapper border-bottom white-bg page-heading mb-5">
        <div class="col-lg-12">
            <h2><i class="fa fa-product-hunt" aria-hidden="true"></i> View Order Management</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.dashboard') }}">Dashboard</a>
                </li>
                <li class="breadcrumb-item active">
                    <span class="label label-success float-right all_backgroud"><strong>View Order Table</strong></span>
                </li>
            </ol>
        </div>
    </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach ($ProductOrder as $value)
                                                                        <tr>
                                                                            ...
                                                                            <td class="tm_width_3">₹ {{ $value->price }}
                                                                            </td>
