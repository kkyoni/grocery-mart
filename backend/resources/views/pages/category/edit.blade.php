	...
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">
				<span class="label label-success float-right all_backgroud"><strong>Edit Category Form</strong></span>
			</li>
		</ol>
	</div>
</div>
		...
		<div class="col-lg-12">
			<div class="ibox">
				<div class="ibox-content">
					{!!Form::model($category,array('method'=>'post','files'=>true,'route'=>array('category.update',$category->id)))!!}
