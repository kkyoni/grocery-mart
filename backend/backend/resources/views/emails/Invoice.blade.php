...
<head>
    ...
    <title>Grocery Mart - Invoice</title>
    <style>
                ...
                <div class="tm_invoice_in">
                    <div class="tm_invoice_head tm_align_center tm_mb20">
                        <div class="tm_invoice_left">
                            <div class="tm_logo">
                                <img src="{{ asset('uploads/settings/application_logo.png') }}" alt="application_logo">
                            </div>
                        </div>
                    </div>
                    <div class="tm_invoice_info tm_mb20">
                        ...
                        <div class="tm_invoice_info_list">
                            <p class="tm_invoice_number tm_m0">Invoice No: <b
                                    class="tm_primary_color">#{{ $invoice }}</b></p>
                            <p class="tm_invoice_date tm_m0">Date: <b class="tm_primary_color">{{ $date }}</b>
                            </p>
                        </div>
                    </div>
                    <div class="tm_invoice_head tm_mb10">
                        ...
                        <div class="tm_invoice_right tm_text_right">
                            ...
                            <p>
                                {{ $userName }} <br>
                                {{ $street_address }},{{ $city }} <br>
                                {{ $states }},{{ $country }},{{ $zip }}<br>
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="tm_right_footer">
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Shopping</td>
                                            <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">
                                                +₹ 0.00</td>
                                        </tr>
                                        <tr>
                                            <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Sales Tax
                                        ...
                                        <tr>
                                            <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0 tm_bold">Promo
                                                Code</td>
                                            <td
