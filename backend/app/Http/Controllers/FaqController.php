    ...
    public function index(Builder $builder, Request $request){
        ...
        if (request()->ajax()) {
            ...
            ->editColumn('action', function (Faq $faq) {
                $action  = '';
                $action .= '<a class="btn btn-warning btn-circle btn-sm" href='.route('faq.edit',[$faq->id]).'><i class="fa fa-pencil" data-toggle="tooltip" title="Edit"></i></a>';
