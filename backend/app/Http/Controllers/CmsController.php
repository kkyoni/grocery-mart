    ...
    public function index(Builder $builder, Request $request){
        ...
        if (request()->ajax()) {
            ...
            ->editColumn('action', function (Cms $cms) {
                $action  = '';
                $action .= '<a class="btn btn-warning btn-circle btn-sm" href='.route('cms.edit',[$cms->id]).'><i class="fa fa-pencil" data-toggle="tooltip" title="Edit"></i></a>';
